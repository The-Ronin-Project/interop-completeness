...
object RunDOs : Table<RunDO>("run") {
    ...
    val runStartTime = utcDateTime("run_start_time").bindTo { it.runStartTime }
    val runEndTime = utcDateTime("run_end_time").bindTo { it.runEndTime }
    ...
    val eventDateTime = utcDateTime("event_dt_tm").bindTo { it.eventDateTime }
}
